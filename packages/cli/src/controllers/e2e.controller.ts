...
export class E2EController {
	private enabledFeatures: Record<BooleanLicenseFeature, boolean> = {
		...
		[LICENSE_FEATURES.SHOW_NON_PROD_BANNER]: true,
		...
		[LICENSE_FEATURES.AI_CREDITS]: true,
		...
		[LICENSE_FEATURES.OIDC]: true,
		[LICENSE_FEATURES.MFA_ENFORCEMENT]: true,
	};
	...
	constructor(
		...
		license.isLicensed = (feature: BooleanLicenseFeature) => true;
